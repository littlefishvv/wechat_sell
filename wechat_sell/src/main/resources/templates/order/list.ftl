				...
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-footer">
							 ...
							 <button onclick="location.reload()" type="button" class="btn btn-primary">查看订单列表</button>
						      <button id="unmute" onClick="document.getElementById('notice').muted = false;">打开声音</button>
						</div>
					</div>
...
<#-- 弹窗，播放音乐 -->		
<video id="notice" muted autoplay loop="loop">
